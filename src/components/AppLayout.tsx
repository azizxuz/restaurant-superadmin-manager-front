...
export function AppLayout({ requiredRole }: AppLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <aside className={`
        fixed lg:static inset-y-0 left-0 z-50 w-64 bg-sidebar text-sidebar-foreground flex flex-col shrink-0
      ...
      <main className="flex-1 overflow-auto min-w-0">
        <div className="sticky top-0 z-30 lg:hidden bg-background border-b border-border px-4 py-3 flex items-center gap-3">
